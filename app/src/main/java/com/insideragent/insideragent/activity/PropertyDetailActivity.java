...
import com.insideragent.insideragent.fragment.CompsFragment;
import com.insideragent.insideragent.fragment.OverviewFragment;
...
import com.insideragent.insideragent.utils.CustomImageSlider;
import com.insideragent.insideragent.utils.NetworkConnection;
import com.insideragent.insideragent.utils.PropertyDetailsPref;
...
public class PropertyDetailActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        switch (buyerDetailsPref.getStringPref(PropertyDetailActivity.this, buyerDetailsPref.LOGIN_TYPE)) {
            case "BUYER":
                tvContactUs.setText("CONTACT AGENT");
                break;

            case "INSIDER":
                tvContactUs.setText("SHARE WITH BUYERS");
                break;
        }
            ...
            public void onClick(View v) {
                switch (buyerDetailsPref.getStringPref(PropertyDetailActivity.this, buyerDetailsPref.LOGIN_TYPE)) {
                    case "BUYER":
                        ...
                        Log.e("addresssssssss", address);
                        Intent intent5 = new Intent(PropertyDetailActivity.this, ContactUsActivity.class);
                        intent5.putExtra(AppConfigTags.PROPERTY_ADDRESS, address);
