...
public class ContactUsAdminActivity extends AppCompatActivity {
    ...
    private void initData () {
        ...
        progressDialog = new ProgressDialog (ContactUsAdminActivity.this);
        Log.e ("MOBILE", "" + buyerDetailsPref.getStringPref (ContactUsAdminActivity.this, BuyerDetailsPref.BUYER_MOBILE));
        etName.setText (buyerDetailsPref.getStringPref (ContactUsAdminActivity.this, BuyerDetailsPref.INSIDER_USERNAME));
        
        etEmail.setText (buyerDetailsPref.getStringPref (ContactUsAdminActivity.this, BuyerDetailsPref.INSIDER_EMAIL));
        
        etMobile.setText (buyerDetailsPref.getStringPref (ContactUsAdminActivity.this, BuyerDetailsPref.INSIDER_MOBILE));
    }
    ...
    private void initListener () {
        tvSubmit.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick (View view) {
                ...
                s.setSpan (new TypefaceSpan (ContactUsAdminActivity.this, Constants.font_name), 0, s.length (), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                SpannableString s2 = new SpannableString (getResources ().getString (R.string.please_enter_email));
                s2.setSpan (new TypefaceSpan (ContactUsAdminActivity.this, Constants.font_name), 0, s2.length (), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                SpannableString s3 = new SpannableString (getResources ().getString (R.string.please_enter_mobile));
                s3.setSpan (new TypefaceSpan (ContactUsAdminActivity.this, Constants.font_name), 0, s3.length (), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                SpannableString s6 = new SpannableString (getResources ().getString (R.string.please_enter_valid_email));
                s6.setSpan (new TypefaceSpan (ContactUsAdminActivity.this, Constants.font_name), 0, s6.length (), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                SpannableString s7 = new SpannableString (getResources ().getString (R.string.please_enter_message));
                s7.setSpan (new TypefaceSpan (ContactUsAdminActivity.this, Constants.font_name), 0, s7.length (), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    private void contactDetailsSendToServer (final String name, final String email, final String number, final String message) {
        if (NetworkConnection.isNetworkAvailable (ContactUsAdminActivity.this)) {
                        ...
                        public void onResponse (String response) {
                            ...
                            if (response != null) {
                                try {
                                    ...
                                    if (! error) {
                                        Utils.showSnackBar (ContactUsAdminActivity.this, clMain, message, Snackbar.LENGTH_LONG, null, null);
                                    ...
                                    progressDialog.dismiss ();
                                    Utils.showSnackBar (ContactUsAdminActivity.this, clMain, getResources ().getString (R.string.snackbar_text_exception_occurred), Snackbar.LENGTH_LONG, getResources ().getString (R.string.snackbar_action_dismiss), null);
                                    e.printStackTrace ();
                                }
                            } else {
                                Utils.showSnackBar (ContactUsAdminActivity.this, clMain, getResources ().getString (R.string.snackbar_text_error_occurred), Snackbar.LENGTH_LONG, getResources ().getString (R.string.snackbar_action_dismiss), null);
